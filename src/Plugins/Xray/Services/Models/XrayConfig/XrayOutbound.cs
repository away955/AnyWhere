...
/// 出站连接配置
/// </summary>
public sealed class XrayOutbound
{
    /// <summary>
...
public sealed class OutboundUser
{
...
public sealed class OutboundStreamSettings
{
...
public sealed class OutboundProxySettings
{
    public string? tag { get; set; }
}

public sealed class OutboundMux
{
    /// <summary>
    /// 是否启用 Mux 转发请求
    /// </summary>
