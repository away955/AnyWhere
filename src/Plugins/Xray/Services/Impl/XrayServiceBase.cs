...
public abstract partial class XrayServiceBase : IXrayServiceBase
{
    ...
    public XrayServiceBase(string ConfigFileName)
    {
        Config = XrayConfig.Default;
        var baseDirectory = Path.Combine(Constant.RootPath, "Data");
